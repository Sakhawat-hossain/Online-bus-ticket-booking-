...
<div class="section">
    ...
    <div class="container" style="min-height: 500px;">
        ...
        <form method="post" action="agent-search-buses-with-filter">
            {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            @else
                                <input class="form-control" type="date" name="departure" required>
                            @endif
                        </div>
                    </div>
                    <input type="text" name="username" value="{{\Illuminate\Support\Facades\Session::get('agent-username')}}" hidden>
                    <div class="col-sm-2">
                ...
                @if(isset($searchdata))
                    @foreach($searchdata as $datarow)
                        ...
                        @foreach($datarow as $data)
                            @if($i==9)
                                <td><a role="button" class="btn btn-success" href="{{url('agent-seat-list-details',['id' => $data])}}">View seats</a></td>
                            @else
                                <td>{{$data}}</td>
                            @endif
                            @php $i=1+$i @endphp
