        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="">
                            Dashboard <small> Places</small> </h1><br>
                            <nav class="navbar" style=" background:black;">
                                    <div class="container-fluid">
                                      
                                        <ul class="nav navbar-nav">
                                            <li class="active" style="background:white;"><a href="#" style="color:black;">All Places</a></li>
                                            <li><a href="representative-add-place">Add Places</a></li>
                                    ...
                                    <tbody>
                                        @foreach ($p as $r)
                                                    ...
                                                    <tr>
                                                            ...
                                                            <a role="button" type="submit" class="btn btn-success" href="representative-place-details/{{$r->id}}">Details
                                                                    
                                                                </a>
                                                            </td>
                                                            <td>
                                                                
                                                                <a role="button" type="submit" class="btn btn-success" href="representative-place-edit/{{$r->id}}">Edit
