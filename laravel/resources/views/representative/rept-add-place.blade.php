        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                        ...
                        <h1 class="">
                            ...
                            <nav class="navbar" style=" background:black;">
                                    <div class="container-fluid">
                                        ...
                                        <ul class="nav navbar-nav">
                                            <li ><a href="places_view">All Routes</a></li>
                                            <li class="active" style="background:white;"><a href="#" style="color:black;">Add Place</a></li>
                                            <li><a href="#">Search Place</a></li>
                ...
                @if (session()->has("message"))
                    ...
                    @endif
                <div class="row" >
                        <form method="post" action="representative-add-place">
                                {{csrf_field()}}
                                     ...
                                     <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                <span class="form-label">Place Name</span>
                                                <input  name="name" id="fromj" required>
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-sm-4">
                                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                                    ...
                                                    <input  name="address" id ="toj" required>
