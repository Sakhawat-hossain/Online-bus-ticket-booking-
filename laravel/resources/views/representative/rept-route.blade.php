                    ...
                    <h1 class="">
                        ...
                        <nav class="navbar" style=" background:black;">
                                <div class="container-fluid">
                                    ...
                                    <ul class="nav navbar-nav">
                                        <li class="active" style="background:white;"><a href="#" style="color:black;">All Routes</a></li>
                                ...
                                <tbody>
                                    @foreach ($routes as $r)
                                                ...
                                                <tr>
                                                        ...
                                                        <a role="button" type="submit" class="btn btn-success" href="representative-route-details/{{$r->id}}">Details
                                                                
                                                            </a>
                                                        </td>
                                                        <td>
                                                            
                                                            <a role="button" type="submit" class="btn btn-success" href="representative-route-edit/{{$r->id}}">Edit
