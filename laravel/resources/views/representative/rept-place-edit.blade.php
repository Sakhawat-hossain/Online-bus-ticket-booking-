        ...
        <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="">
                                Dashboard <small> Place edit</small> </h1><br>
                                
                           
                        </div>
                    </div>
            <form action="../representative-place-update/{{$p_id}}" method="post">
               {{csrf_field()}}
                    <div class="row">
                                                ...
                                                @foreach ($p as $r)
                                                     ...
                                                     <div class="col-md-4">
                                                            <div class="form-group">
                                                                    ...
                                                                    <input  name="name" id="fromj" value="{{$r->name}}">
                                                     ...
                                                     <div class="col-md-4">   
                                                                    <div class="form-group">
                                                                            ...
                                                                            <input type="text" name="address" id="toj" value="{{$r->address}}">
                    ...
                    <div class="form-btn" style="margin-top: 20px;float: right;margin-right:80px;">
                            <button type="submit" class="btn btn-success" name="sendval" value="normal">Update</button>
                    </div>
            </form>
        </div>
