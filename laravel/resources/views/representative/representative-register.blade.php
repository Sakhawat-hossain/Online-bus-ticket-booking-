...
<div class="container" style="min-height: 500px;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            @if(\Illuminate\Support\Facades\Session::has('registerInfo'))
                <h3 style="color: forestgreen;">{{\Illuminate\Support\Facades\Session::get('registerInfo')}}</h3>
                @php Session::forget('registerInfo'); @endphp
            @endif
            <div class="panel panel-default">
                <div class="panel-heading">Register as Representative</div>

                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="../representative">
                        {{ csrf_field() }}
