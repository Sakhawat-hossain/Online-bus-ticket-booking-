...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<title>Bus Booking System | Customers</title>
		<link id="browser_favicon" rel="shortcut icon" href="resources/images/appgini-icon.png">

		<link rel="stylesheet" href="assets/resources/initializr/css/paper.css">
	...
	<body>
		<div class="container theme-paper theme-compact">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><i class="glyphicon glyphicon-home"></i> Bus Booking System</a>
			</div>
