...
<!--     $options->ShowTableHeader = 0;     -->
		...
		<td id="customers-fullname-1" class="customers-fullname"><a onclick="document.myform.SelectedField.value=this.parentNode.cellIndex; document.myform.SelectedID.value='1'; document.myform.submit(); return false;" href="customers_view.php?SelectedID=1" style="display: block; padding:0px;">Nihad mia</a></td>
		<td id="customers-phone-1" class="customers-phone"><a onclick="document.myform.SelectedField.value=this.parentNode.cellIndex; document.myform.SelectedID.value='1'; document.myform.submit(); return false;" href="customers_view.php?SelectedID=1" style="display: block; padding:0px;">0172345678</a></td>
		<td id="customers-id_number-1" class="customers-id_number"><a onclick="document.myform.SelectedField.value=this.parentNode.cellIndex; document.myform.SelectedID.value='1'; document.myform.submit(); return false;" href="customers_view.php?SelectedID=1" style="display: block; padding:0px;">1001</a></td>
</tr>
<!-- tv data above -->
</tbody>
	<tfoot><tr><td colspan=4>Records 1 to 1 of 1</td></tr></tfoot></table></div>
